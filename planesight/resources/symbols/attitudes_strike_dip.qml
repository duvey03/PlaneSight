...
<!-- PlaneSight strike/dip point style. __SVG__ is substituted with the absolute
     path to strike_dip_bedding.svg by scripts/nepal_slice.py. SVG marker rotated
     by dip_dir, stroke coloured by reliability, dip value labelled. -->
<qgis version="3.34.0" styleCategories="Symbology|Labeling">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <placement placement="1" dist="2" distUnits="MM"/>
    </settings>
  </labeling>
</qgis>
